...
An enterprise GeoAI platform enabling **natural language queries** over spatial databases using a **7-agent AI swarm architecture**.
...
|:----------|:----------|:-----------|
| **Processing Time** | 2 days → 2 hours | 50,000+ property records bi-weekly |
| **Emergency Assessments** | 10,000+ | Flood & fire disaster recovery |
| **Support Reduction** | 70% fewer requests | AI-powered spatial queries |
| **Venice Biennale 2025** | Featured | Earth observation & habitat modeling |
...
### 🏛️ Municipal Property Automation
**Greater Shepparton Council**

Automated ETL pipeline processing 50,000+ property records bi-weekly
- ⚡ 90% time reduction
- 🔄 FME + Python + PostgreSQL
...
Earth observation & AI habitat modeling for endangered species restoration in Venice Lagoon
- 🛰️ Satellite imagery analysis
- 🤖 ML habitat prediction
...
### 🏠 Digital Twin IoT System
**University of Melbourne Capstone**

Real-time indoor environment monitoring with LoRaWAN & MQTT
- 📡 4-layer architecture
- 🌡️ CO₂, temperature, humidity tracking
...
💡 **Open to collaborations on GeoAI, spatial automation, and open-source GIS projects**

I'm particularly interested in:
- 🤖 AI/ML applications in geospatial analysis
